...
<head>
    ...
    <style>
        ...
        .navbar { display:flex; justify-content:space-between; align-items:center; background:#ffffff; color:#333; padding:15px 30px; border-bottom:1px solid #e9ecef; }
        .navbar a { color:#6c757d; margin-left:15px; text-decoration:none; font-weight:bold; }
        ...
        .price { font-size:22px; font-weight:bold; margin:20px 0; color:#6c757d; }
        .btn { display:inline-block; padding:10px 20px; margin-right:10px; margin-top:10px; background:#6c757d; color:white; text-decoration:none; border-radius:5px; font-weight:bold; }
