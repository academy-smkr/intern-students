...
.wishlist-item .price { color:#6c757d; font-weight:bold; }
.btn { padding:6px 12px; background:#6c757d; color:white; border-radius:5px; text-decoration:none; }
        ...
        <?php while($item = $result->fetch_assoc()): ?>
            <div class="wishlist-item">
                ...
                <div>
                    ...
                    <a href="cart/wishlist_remove.php?id=<?= $item['id'] ?>" class="btn" style="background:#495057;">Remove</a> 
                </div>
            </div>
        <?php endwhile; ?>
    <?php else: ?>
