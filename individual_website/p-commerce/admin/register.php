...
<html>
<head>
    <title>PawMart Admin Registration</title>
    <style>
        body { font-family: 'Nunito', Arial, sans-serif; background: #f8f6f2; }
        .container { max-width: 400px; margin: 50px auto; background: white; padding: 20px; border-radius: 8px; box-shadow: 0 10px 20px rgba(0,0,0,0.08); }
        ...
        input[type=submit] { width: 100%; padding: 10px; background: #1f6f5f; color: white; border: none; border-radius: 4px; cursor: pointer; }
        input[type=submit]:hover { background: #1a5b4f; }
        .message { color: red; text-align: center; margin-bottom: 15px; }
    </style>
</head>
<body>
<div class="container">
    <h2>PawMart Admin Registration</h2>
